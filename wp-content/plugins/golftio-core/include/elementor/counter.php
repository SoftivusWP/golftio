...
class TP_counter extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'content_bg_section',
            [
                'label' => esc_html__('Counter Background', 'golftio-core'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__('100', 'golftio-core'),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'rows' => 10,
                'default' => esc_html__('Active Member', 'golftio-core'),
        ...
        $this->add_control(
            'card_repeater',
            [
                'label' => esc_html__('Counter Card', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'golftio_counter_text' => esc_html__('Active Member', 'golftio-core'),
                ...
                'title_field' => '{{{ golftio_counter_text }}}',
                    ...
                    <?php foreach ($settings['card_repeater'] as $item) : ?>
                        <div class="col-sm-6 col-lg-3 section__col">
                            <div class="counter__card">
                                <?php if (!empty($item['golftio_counter_card_icon'])) :   ?>
                                    <div class="counter__card-thumb">
                                        <?php \Elementor\Icons_Manager::render_icon($item['golftio_counter_card_icon'], ['aria-hidden' => 'true']); ?>
                                    </div>
                                <?php endif ?>
                                <div class="counter__card-content">
                                    <?php if (!empty($item['golftio_counter_number'])) :   ?>
                                        <h2 class="counter-part"><span class="odometer" data-odometer-final="<?php echo esc_html($item['golftio_counter_number']) ?>"></span> <span><?php echo esc_html($item['golftio_counter_sign']) ?></span></h2>
                                    <?php endif ?>
                                    <?php if (!empty($item['golftio_counter_text'])) :   ?>
                                        <p class="counter_text primary-text"><?php echo wp_kses($item['golftio_counter_text'], wp_kses_allowed_html('post'))  ?></p>
                                    <?php endif ?>
                                </div>
                            </div>
                        </div>
