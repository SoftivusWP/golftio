    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Lets Get Started!', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'rows' => 10,
                'default' => esc_html__('Please Enter your Email Address to join our club', 'golftio-core'),
                    ...
                    <div class="col-lg-8 col-xxl-6">
                        <div class="authentication__wrapper">
                            <?php if (!empty($settings['golftio_heading_content_title'])) :   ?>
                                <h4 class="title"><?php echo wp_kses($settings['golftio_heading_content_title'], wp_kses_allowed_html('post'))  ?></h4>
                            <?php endif ?>
