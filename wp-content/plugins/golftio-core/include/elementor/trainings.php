    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                ...
                'condition' => [
                    'golftio_content_style_selection' => 'style_one',
                ]
            ]
        );
        ...
        $this->add_control(
            'golftio_heading_one_content_subtitle',
            [
                'label' => esc_html__('Subtitle', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Trainings', 'golftio-core'),
        ...
        $this->add_control(
            'golftio_heading_one_content_description',
            [
                'label' => esc_html__('Description', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas doloribus provident assumenda quidem.', 'golftio-core'),
                'rows' => 10,
        ...
        $this->add_control(
            'golftio_heading_three_content_subtitle',
            [
                'label' => esc_html__('Subtitle', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Trainings', 'golftio-core'),
        ...
        $this->add_control(
            'golftio_heading_three_content_title',
            [
                'label' => esc_html__('Title', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Default title', 'golftio-core'),
        ...
        $this->add_control(
            'golftio_heading_three_content_description',
            [
                'label' => esc_html__('Description', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas doloribus provident assumenda quidem.', 'golftio-core'),
        ...
        $this->add_control(
            'golftio_heading_four_content_subtitle',
            [
                'label' => esc_html__('Subtitle', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Trainings', 'golftio-core'),
        ...
        $this->add_control(
            'golftio_heading_four_content_title',
            [
                'label' => esc_html__('Title', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Default title', 'golftio-core'),
        ...
        $this->add_control(
            'golftio_heading_four_content_description',
            [
                'label' => esc_html__('Description', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas doloribus provident assumenda quidem.', 'golftio-core'),
        ...
        //     [
        //         'label' => esc_html__('Show/Hide', 'golftio-core')
        //     ]
        // );
        ...
        //     [
        //         'label' => esc_html__('Show Feature Title?', 'golftio-core'),
        //         'type' => \Elementor\Controls_Manager::SWITCHER,
        //         'label_on' => esc_html__('Show', 'golftio-core'),
        //         'label_off' => esc_html__('Hide', 'golftio-core'),
        //         'return_value' => 'yes',
        //         'default' => 'yes',
        //     ]
        // );
        ...
        //     [
        //         'label' => esc_html__('Show Review/Rating?', 'golftio-core'),
        //         'type' => \Elementor\Controls_Manager::SWITCHER,
        //         'label_on' => esc_html__('Show', 'golftio-core'),
        //         'label_off' => esc_html__('Hide', 'golftio-core'),
        //         'return_value' => 'yes',
        ...
        //     'trainings_link_show',
        //     [
        //         'label' => esc_html__('Show Source/Link?', 'golftio-core'),
        //         'type' => \Elementor\Controls_Manager::SWITCHER,
        //         'label_on' => esc_html__('Show', 'golftio-core'),
        //         'label_off' => esc_html__('Hide', 'golftio-core'),
        //         'return_value' => 'yes',
        ...
        $this->start_controls_section(
            ...
            [
                ...
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'golftio_content_style_selection' => ['style_one', 'style_two', 'style_four']
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Btn Secondary Hover Color', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .cmn-button.cmn-button--secondary' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'golftio_content_style_selection' => ['style_two', 'style_four']
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Btn Secondary', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_bgcolor',
            [
                'label'     => esc_html__('Btn BG Primary', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_hvr_bgcolor',
            [
                'label'     => esc_html__(' Btn Hover BG Primary', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Btn Secondary BG', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Btn Secondary BG Hover', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="section__header">
                                <?php if (!empty($settings['golftio_heading_one_content_subtitle'])) :   ?>
                                    <h5 class="sub-title"><?php echo wp_kses($settings['golftio_heading_one_content_subtitle'], wp_kses_allowed_html('post'))  ?></h5>
                                <?php endif ?>
                                ...
                                <?php endif ?>
                                <?php if (!empty($settings['golftio_heading_one_content_description'])) :   ?>
                                    <p class="xlr pp"><?php echo wp_kses($settings['golftio_heading_one_content_description'], wp_kses_allowed_html('post'))  ?></p>
                                <?php endif ?>
                            </div>
                        </div>
                    </div>
            ...
            <section class="section training--tertiary wow fadeInUp" data-wow-duration="0.4s">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="section__header">
                                <?php if (!empty($settings['golftio_heading_three_content_subtitle'])) : ?>
                                    <h5 class="sub-title"><?php echo wp_kses($settings['golftio_heading_three_content_subtitle'], wp_kses_allowed_html('post'))  ?></h5>
                                <?php endif; ?>
                                <?php if (!empty($settings['golftio_heading_three_content_title'])) : ?>
                                    <h2 class="title"><?php echo wp_kses($settings['golftio_heading_three_content_title'], wp_kses_allowed_html('post'))  ?></h2>
                                <?php endif; ?>
                                <?php if (!empty($settings['golftio_heading_three_content_description'])) : ?>
                                    <p class="xlr pp"><?php echo wp_kses($settings['golftio_heading_three_content_description'], wp_kses_allowed_html('post'))  ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="section__header wow fadeInUp" data-wow-duration="0.4s">
                                <?php if (!empty($settings['golftio_heading_four_content_subtitle'])) : ?>
                                    <h5 class="sub-title"><?php echo wp_kses($settings['golftio_heading_four_content_subtitle'], wp_kses_allowed_html('post'))  ?></h5>
                                <?php endif; ?>
                                <?php if (!empty($settings['golftio_heading_four_content_title'])) : ?>
                                    <h2 class="title"><?php echo wp_kses($settings['golftio_heading_four_content_title'], wp_kses_allowed_html('post'))  ?></h2>
                                <?php endif; ?>
                                <?php if (!empty($settings['golftio_heading_four_content_description'])) : ?>
                                    <p class="xlr pp"><?php echo wp_kses($settings['golftio_heading_four_content_description'], wp_kses_allowed_html('post'))  ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
