    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'golftio_button_content_style' => 'style_one',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'golftio_button_content_style' => 'style_two',
                ]
            ]
        );
...
?>
        ...
        <?php if ($settings['golftio_heading_content_style_selection'] == 'style_one') : ?>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="section__header mb-0 headingbtn wow fadeInUp" data-wow-duration="0.4s">
                            ...
                            <?php endif ?>
                            <?php if ($settings['golftio_button_content_style'] == 'style_one') : ?>
                                ...
                                <?php endif ?>
                            <?php endif ?>
                            <?php if ($settings['golftio_button_content_style'] == 'style_two') : ?>
                                <?php if (!empty($settings['golftio_content_button'])) : ?>
                                    <div class="section__header-cta">
                                        <a href="<?php echo esc_html($settings['golftio_content_button_url']['url']) ?>" class="cmn-button cmn-button--secondary"><?php echo esc_html($settings['golftio_content_button']) ?></a>
                                    </div>
                                <?php endif ?>
                            <?php endif ?>
                        </div>
        ...
        <?php if ($settings['golftio_heading_content_style_selection'] == 'style_two') : ?>
            <div class="section__header mb-0 headingbtn wow fadeInUp" data-wow-duration="0.4s">
                <?php if (!empty($settings['golftio_heading_content_subtitle'])) :   ?>
                    <h5 class="sub-title"><?php echo wp_kses($settings['golftio_heading_content_subtitle'], wp_kses_allowed_html('post'))  ?></h5>
                <?php endif ?>
