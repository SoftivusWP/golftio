...
class TP_join_club extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Join Club Section', 'golftio-core')
            ]
        );


        $this->add_control(
            'golftio_join_club_content_style_selection',
            [
        ...
        $this->start_controls_section(
            ...
            [
                ...
                'condition' => [
                    'golftio_join_club_content_style_selection' => 'style_one',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Join Club', 'golftio-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Content', 'golftio-core'),
                'condition' => [
                    'golftio_join_club_content_style_selection' => 'style_two',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .join-club' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Form Input Color', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'form_bg_style_color',
            [
                'label'     => esc_html__('Form Color', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
...
?>
        ...
        <?php if ($settings['golftio_join_club_content_style_selection'] == 'style_one') : ?>
        ...
        <?php if ($settings['golftio_join_club_content_style_selection'] == 'style_two') : ?>
                        ...
                        <div class="col-lg-10 offset-lg-2 col-xl-6 offset-xl-6">
                            <div class="section__content">
                                ...
                                <?php if (!empty($settings['golftio_heading_content_title_two'])) :   ?>
                                    <h2 class="title"><?php echo wp_kses($settings['golftio_heading_content_title_two'], wp_kses_allowed_html('post'))  ?></h2>
                                <?php endif ?>
                                <div class="join-club__form">
