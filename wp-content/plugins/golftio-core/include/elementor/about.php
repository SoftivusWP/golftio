...
class TP_about extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'golftio_about_section_genaral',
            [
                'label' => esc_html__('About Section', 'golftio-core')
            ]
        );


        $this->add_control(
            'golftio_about_content_style_selection',
            [
                'label'   => esc_html__('Select Style', 'golftio-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'style_one' => esc_html__('Style One', 'golftio-core'),
                    'style_one_alt' => esc_html__('Style One Alt', 'golftio-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Counter', 'golftio-core'),
                'condition' => [
                    'golftio_about_content_style_selection' => ['style_one', 'style_one_alt'],
                ]
            ]
        );
        ...
        $this->add_control(
            'golftio_about_one_content_image',
            [
        ...
        $this->add_control(
            'golftio_counter_number',
            [
                'label' => esc_html__('Counter number', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('30', 'golftio-core'),
                'placeholder' => esc_html__('Type your number here', 'golftio-core'),
                'label_block' => true,
            ]
        );

        $this->add_control(
            'golftio_counter_sign',
            [
                'label' => esc_html__('Counter Sign', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
        ...
        $this->add_control(
            'golftio_counter_text',
            [
                'label' => esc_html__('Title', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'rows' => 10,
                'default' => esc_html__('experience', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('About Us', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'rows' => 10,
                'default' => esc_html__('We offer a lot of courses of varying difficulty and beautiful scenery that golfers of all skill levels can enjoy. You will learn golf from professionals with our competent and experienced staff. You will have a great fun with our magnificent illuminated field.', 'golftio-core'),
                'placeholder' => esc_html__('Type your description here', 'golftio-core'),
            ]
        );
        ...
        // Button URL
        $this->add_control(
            'golftio_content_button_url_one',
            [
        ...
        $this->start_controls_section(
            'about_content_two',
            [
                'label' => esc_html__('Left Content', 'golftio-core'),
                'condition' => [
                    'golftio_about_content_style_selection' => 'style_two'
                ]
            ]
        );

        $this->add_control(
            'golftio_about_two_content_image',
            [
                'label' => esc_html__('Choose Image', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
        ...
        $this->add_control(
            'golftio_counter_two_text',
            [
                'label' => esc_html__('Title', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'rows' => 10,
                'default' => esc_html__('Years of experience', 'golftio-core'),
                'placeholder' => esc_html__('Type your description here', 'golftio-core'),
                'label_block' => true,
            ]
        );
        ...
        //Heading Section
        $this->start_controls_section(
            'golftio_heading_two_section_genaral',
            [
                'label' => esc_html__('Right Content', 'golftio-core'),
                'condition' => [
                    'golftio_about_content_style_selection' => 'style_two'
                ]
            ]
        ...
        $this->add_responsive_control(
            'golftio_heading_content_two_align',
            [
        ...
        $this->add_control(
            'golftio_heading_content_two_subtitle',
            [
                'label' => esc_html__('Subtitle', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('About Us', 'golftio-core'),
        ...
        $this->add_control(
            'golftio_heading_content_two_title',
            [
                'label' => esc_html__('Title', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Default Title', 'golftio-core'),
        ...
        $this->add_control(
            'golftio_heading_content_two_description',
            [
                'label' => esc_html__('Short Description', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'rows' => 10,
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'golftio_card_title' => esc_html__('Default title', 'golftio-core'),
                ...
                'title_field' => '{{{ golftio_card_title }}}',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Counter', 'golftio-core'),
                'condition' => [
                    'golftio_about_content_style_selection' => 'style_three',
                ]
            ]
        );
        ...
        $this->add_control(
            'golftio_about_three_content_image',
            [
                'label' => esc_html__('Choose Image', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
        ...
        $this->add_control(
            'golftio_heading_content_three_subtitle',
            [
                'label' => esc_html__('Subtitle', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('About Us', 'golftio-core'),
        ...
        $this->add_control(
            'golftio_heading_content_three_title',
            [
                'label' => esc_html__('Title', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Default Title', 'golftio-core'),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Button', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('button', 'golftio-core'),
                'placeholder' => esc_html__('Type your tab name here', 'golftio-core'),
                'label_block' => true,
            ]
        );

        $repeater->add_control(
            'golftio_card_content_tab',
            [
                'label' => esc_html__('Description', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'rows' => 10,
                'default' => esc_html__('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic...', 'golftio-core'),
                'placeholder' => esc_html__('Type your description here', 'golftio-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'golftio_card_tab' => esc_html__('button1', 'golftio-core'),

                    ],
                    [
                        'golftio_card_tab' => esc_html__('button2', 'golftio-core'),

                    ],
                    [
                        'golftio_card_tab' => esc_html__('button3', 'golftio-core'),

                    ],

                ],
                'title_field' => '{{{ golftio_card_tab }}}',
            ]
        );

        // Button text
        $this->add_control(
            'golftio_content_button_three',
            [
                'label' => esc_html__('Button', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Read More', 'golftio-core'),
        ...
        // Button URL
        $this->add_control(
            'golftio_content_button_url_three',
            [
                'label' => esc_html__('Button URL', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::URL,
                'placeholder' => esc_html__('https://your-link.com', 'golftio-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Counter Icon', 'golftio-core'),
        ...
        $this->start_controls_section(
            'counter_text_style',
            [
                'label' => esc_html__('Counter Text', 'golftio-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
...
?>
        ...
        <?php if ($settings['golftio_about_content_style_selection'] == 'style_one') : ?>
            <!-- ==== about section start ==== -->
                    ...
                    <div class="row section__row align-items-center">
                        <div class="col-lg-6 col-xl-5 section__col order-last order-lg-first">
                            <div class="about__thumb dir-rtl wow fadeInUp" data-wow-duration="0.4s">
                                <img src="<?php echo esc_url($settings['golftio_about_one_content_image']['url']) ?>" alt="<?php echo esc_attr('Image') ?>" class="unset">
                                <div class="about__experience">
                                    <?php if (!empty($settings['golftio_counter_card_icon'])) :   ?>
                                        <div class="counter_icon about__experience-thumb">
                                            <?php \Elementor\Icons_Manager::render_icon($settings['golftio_counter_card_icon'], ['aria-hidden' => 'true']); ?>
                                        </div>
                                    <?php endif ?>
                                    <?php if (!empty($settings['golftio_counter_number'])) :   ?>
                                        <h3 class="counter-part"><span class="odometer" data-odometer-final="<?php echo esc_html($settings['golftio_counter_number']) ?>"></span> <span><?php echo esc_html($settings['golftio_counter_sign']) ?></span></h3>
                                    <?php endif ?>
                                    <?php if (!empty($settings['golftio_counter_text'])) :   ?>
                                        <p class="counter_text"><?php echo wp_kses($settings['golftio_counter_text'], wp_kses_allowed_html('post'))  ?></p>
                                    <?php endif ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-6 offset-xl-1 section__col">
                            <div class="section__content">
                                        ...
                                        <div class="about__section-inner__single">
                                            ...
                                            <?php if (!empty($item['golftio_card_title_one'])) :   ?>
                                                <div class="about__section-inner__single-content">
                                                    <h5 class="cart_title"><?php echo esc_html($item['golftio_card_title_one']) ?></h5>
                                ...
                                <?php if (!empty($settings['golftio_content_button_one'])) : ?>
                                    <div class="section__content-cta">
                                        <a href="<?php echo esc_html($settings['golftio_content_button_url_one']['url']) ?>" class="cmn-button"><?php echo esc_html($settings['golftio_content_button_one']) ?></a>
                                    </div>
                                <?php endif ?>
                            </div>
                        </div>
        ...
        <?php if ($settings['golftio_about_content_style_selection'] == 'style_one_alt') : ?>
            <!-- ==== about section start ==== -->
        ...
        <?php if ($settings['golftio_about_content_style_selection'] == 'style_two') : ?>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-xxl-5 d-none d-lg-block">
                            <div class="about--secondary__thumb dir-rtl">
                                <?php if (!empty($settings['golftio_about_two_content_image']['url'])) :   ?>
                                    <img src="<?php echo esc_url($settings['golftio_about_two_content_image']['url']) ?>" alt="<?php echo esc_attr('Image') ?>" class="unset">
                                <?php endif ?>
                                <div class="about--secondary__thumb-experience">
                                    <?php if (!empty($settings['golftio_counter_two_number'])) :   ?>
                                        <h3 class="counter-part"><span class="odometer" data-odometer-final="<?php echo esc_html($settings['golftio_counter_two_number']) ?>"></span> <span><?php echo esc_html($settings['golftio_counter_two_sign']) ?></span></h3>
                                    <?php endif ?>
                                    <?php if (!empty($settings['golftio_counter_two_text'])) :   ?>
                                        <p class="counter_text"><?php echo wp_kses($settings['golftio_counter_two_text'], wp_kses_allowed_html('post'))  ?></p>
                                    <?php endif ?>
                                </div>
                                <div class="about--secondary__modal">
                                    <?php if (!empty($settings['golftio_popup_content_image']['url'])) :   ?>
                                        <img src="<?php echo esc_url($settings['golftio_popup_content_image']['url']) ?>" alt="<?php echo esc_attr('Image') ?>">
                                    <?php endif ?>
                                    <div class="play-wrapper">
                                        <?php if (!empty($settings['golftio_popup_card_icon'])) :   ?>
                                            <a href="<?php echo esc_url($settings['golftio_popup_link']['url']) ?>" class="play-btn" target="<?php echo esc_attr('_blank') ?>" title="<?php echo esc_attr('Youtube Video Player') ?>">
                                                <?php \Elementor\Icons_Manager::render_icon($settings['golftio_popup_card_icon'], ['aria-hidden' => 'true']); ?>
                                            </a>
                                        <?php endif ?>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-7 col-xxl-6 offset-xxl-1">
                            <div class="section__content">
                                <?php if (!empty($settings['golftio_heading_content_two_subtitle'])) :   ?>
                                    <h5 class="sub-title"><?php echo wp_kses($settings['golftio_heading_content_two_subtitle'], wp_kses_allowed_html('post'))  ?></h5>
                                <?php endif ?>
                                <?php if (!empty($settings['golftio_heading_content_two_title'])) :   ?>
                                    <h2 class="title"><?php echo wp_kses($settings['golftio_heading_content_two_title'], wp_kses_allowed_html('post'))  ?></h2>
                                <?php endif ?>
                                <?php if (!empty($settings['golftio_heading_content_two_description'])) :   ?>
                                    <p class="xlr pp"><?php echo wp_kses($settings['golftio_heading_content_two_description'], wp_kses_allowed_html('post'))  ?></p>
                                <?php endif ?>
                                                ...
                                                <?php foreach ($settings['card_two_repeater'] as $item) : ?>
                                                    <div class="col-6 col-sm-4 section__col">
                                                        <div class="about--secondary__single-item">
                                                            <?php if (!empty($item['golftio_card_icon'])) : ?>
                                                                <div class="card_icon about--secondary__single-item__icon icon_thumb">
                                                                    <?php \Elementor\Icons_Manager::render_icon($item['golftio_card_icon'], ['aria-hidden' => 'true']); ?>
                                                                </div>
                                                            <?php endif ?>
                                                            <?php if (!empty($item['golftio_card_title'])) :   ?>
                                                                <h6 class="cart_title"><?php echo esc_html($item['golftio_card_title']) ?></h6>
                                                            <?php endif ?>
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                ...
                                <?php if (!empty($settings['golftio_content_two_button'])) : ?>
                                    <div class="section__content-cta">
                                        <a href="<?php echo esc_html($settings['golftio_content_two_button_url']['url']) ?>" class="cmn-button"><?php echo esc_html($settings['golftio_content_two_button']) ?></a>
                                    </div>
                                <?php endif ?>
                            </div>
                        </div>
        ...
        <?php if ($settings['golftio_about_content_style_selection'] == 'style_three') : ?>
                    ...
                    <div class="row section__row align-items-center">
                        <div class="col-lg-6 col-xl-6 col-xxl-5 section__col">
                            <div class="about--tertiary__thumb wow fadeInUp" data-wow-duration="0.4s">
                                <?php if (!empty($settings['golftio_about_three_content_image']['url'])) :   ?>
                                    <img src="<?php echo esc_url($settings['golftio_about_three_content_image']['url']) ?>" alt="<?php echo esc_attr('Image') ?>">
                                <?php endif ?>
                                <div class="about--tertiary__thumb-experience">
                                    <?php if (!empty($settings['golftio_counter_number_three'])) :   ?>
                                        <h3 class="counter-part"><span class="odometer" data-odometer-final="<?php echo esc_html($settings['golftio_counter_number_three']) ?>"></span> <span><?php echo esc_html($settings['golftio_counter_sign_three']) ?></span></h3>
                                    <?php endif ?>
                                    <?php if (!empty($settings['golftio_counter_text_three'])) :   ?>
                                        <p class="counter_text"><?php echo wp_kses($settings['golftio_counter_text_three'], wp_kses_allowed_html('post'))  ?></p>
                                    <?php endif ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-6 col-xxl-6 offset-xxl-1 section__col">
                            <div class="section__content">
                                <?php if (!empty($settings['golftio_heading_content_three_subtitle'])) :   ?>
                                    <h5 class="sub-title"><?php echo wp_kses($settings['golftio_heading_content_three_subtitle'], wp_kses_allowed_html('post'))  ?></h5>
                                <?php endif ?>
                                <?php if (!empty($settings['golftio_heading_content_three_title'])) :   ?>
                                    <h2 class="title"><?php echo wp_kses($settings['golftio_heading_content_three_title'], wp_kses_allowed_html('post'))  ?></h2>
                                <?php endif ?>
                                <div class="about--secondary__tabs">
                                    <div class="about--secondary__tabs-btn-wrapper">
                                        <?php foreach ($settings['card_tab_repeater'] as $key => $item) : ?>
                                            <?php if (!empty($item['golftio_card_tab'])) :   ?>
                                                <a href="<?php echo "#" . $key ?>" class="about--secondary__tabs-btn <?php echo ($key == 0) ? 'about--secondary__tabs-btn-active' : '' ?>"><?php echo esc_html($item['golftio_card_tab']) ?></a>
                                            <?php endif ?>
                                        <?php endforeach; ?>
                                    </div>
                                    <hr>
                                    <div class="about--secondary__tabs-content-wrapper">
                                        <?php foreach ($settings['card_tab_repeater'] as $key => $item) : ?>
                                            <div class="about--secondary__tabs-content" id="<?php echo $key ?>">
                                                <?php if (!empty($item['golftio_card_content_tab'])) :   ?>
                                                    <p class="tab_content"><?php echo esc_html($item['golftio_card_content_tab']) ?></p>
                                                <?php endif ?>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                                <?php if (!empty($settings['golftio_content_button_three'])) : ?>
                                    <div class="section__content-cta">
                                        <a href="<?php echo esc_html($settings['golftio_content_button_url_three']['url']) ?>" class="cmn-button"><?php echo esc_html($settings['golftio_content_button_three']) ?></a>
                                    </div>
                                <?php endif ?>
                            </div>
                        </div>
