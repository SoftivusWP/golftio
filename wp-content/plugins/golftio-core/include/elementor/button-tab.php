...
class TP_button_tab extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'section_content',
            [
                'label' => __('Tabs', 'golftio-core'),
            ]
        );

        $this->add_responsive_control(
            'golftio_tab_content_align_one',
            [
                'label'         => esc_html__('Tab Text Align', 'golftio-core'),
        ...
        $repeater->add_control(
            'tab_title',
            [
                'label'   => __('Tab Title', 'golftio-core'),
                'type'    => \Elementor\Controls_Manager::TEXT,
                'default' => __('Tab', 'golftio-core'),
            ]
        );
        ...
        $repeater->add_control(
            'tab_form_shortcode',
            [
                'label' => esc_html__('Contact Form Shortcode', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'rows' => 10,
                'placeholder' => esc_html__('Type your Shortcode here', 'golftio-core'),
            ]
        );
        ...
        $this->add_control(
            'tab_repeater',
            [
                'label'       => __('Tab Items', 'golftio-core'),
                'type'        => \Elementor\Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'tab_title'   => __('Tab 1', 'golftio-core'),
                    ],
                    [
                        'tab_title'   => __('Tab 2', 'golftio-core'),
                    ],
                ],
