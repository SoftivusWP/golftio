...
class TP_sponsor extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'golftio_sponsor_card_section_genaral',
            [
                'label' => esc_html__('Sponsor', 'golftio-core')
            ]
        );


        $this->add_control(
            'golftio_sponsor_carousel',
            [
                'label' => esc_html__('Add Sponsor Logo', 'golftio-core'),
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="sponsor__inner">
                            <?php foreach ($settings['golftio_sponsor_carousel'] as $item) : ?>
