...
class TP_testimonial extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'golftio_testimonial_section_genaral',
            [
                'label' => esc_html__('Testimonial Section', 'golftio-core')
            ]
        );


        $this->add_control(
            'golftio_testimonial_content_style_selection',
            [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Testimonial One', 'golftio-core'),
                'condition' => [
                    'golftio_testimonial_content_style_selection' => 'style_one'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            'golftio_card_content_align_one',
            [
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'rows' => 10,
                'default' => esc_html__('There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in', 'golftio-core'),
                'placeholder' => esc_html__('Type your description here', 'golftio-core'),
            ]
        );
            ...
            [
                ...
                'default' => [
                    [
                        ...
                        suffered alteration in', 'golftio-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Testimonial Two', 'golftio-core'),
                'condition' => [
                    'golftio_testimonial_content_style_selection' => 'style_two'
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Join Our Club', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'testi_description' => esc_html__('There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in', 'golftio-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Testimonial Three', 'golftio-core'),
                'condition' => [
                    'golftio_testimonial_content_style_selection' => 'style_three'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            'golftio_heading_content_align_three',
            [
                'label'         => esc_html__('Heading Text Align', 'golftio-core'),
                'type'             => \Elementor\Controls_Manager::CHOOSE,
                'options'         => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Style Three Bg', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Star Icon', 'golftio-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
...
?>
        ...
        <?php if ($settings['golftio_testimonial_content_style_selection'] == 'style_one') : ?>
        ...
        <?php if ($settings['golftio_testimonial_content_style_selection'] == 'style_two') : ?>
        ...
        <?php if ($settings['golftio_testimonial_content_style_selection'] == 'style_three') : ?>
