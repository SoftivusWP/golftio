...
class TP_search extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'golftio_search_card_section_genaral',
            [
                'label' => esc_html__('Search', 'golftio-core')
            ]
        );

        // Button text
        $this->add_control(
            'golftio_submit_button',
            [
                'label' => esc_html__('Button', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Submit', 'golftio-core'),
        ...
        $this->start_controls_section(
            'golftio_search_box_card_section_genaral',
            [
                'label' => esc_html__('Search Box', 'golftio-core'),
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    <form action="<?php echo esc_url(home_url('/')); ?>" method="get">
                        ...
                        <?php if (!empty($settings['golftio_submit_button'])) : ?>
                            <button type="submit" class="cmn-button"><?php echo esc_html($settings['golftio_submit_button']) ?></button>
                        <?php endif ?>
                    </form>
                </div>
            </div>
