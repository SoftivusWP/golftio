...
class TP_pricing extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'golftio_pricing_content_style_selection',
            [
        ...
        $this->add_control(
            'golftio_pricing_content',
            [
                'label' => esc_html__('Pricing', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('$59', 'golftio-core'),
                'placeholder' => esc_html__('<span class="primary-text">$</span>59</span>', 'golftio-core'),
                'label_block' => true,
            ]
        );
        $this->add_control(
            'golftio_pricing_content_title',
            [
                'label' => esc_html__('Title', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Title', 'golftio-core'),
                'placeholder' => esc_html__('Type your title here', 'golftio-core'),
                'label_block' => true,
            ]
        );
        $this->add_control(
            'golftio_pricing_content_description',
            [
                'label' => esc_html__('Short Description', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'rows' => 10,
                'default' => esc_html__('Lorem ipsum dolor sit.', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'golftio_pricing_list' => esc_html__('Type your list content here', 'golftio-core'),
        ...
        // button Start
        $this->start_controls_section(
            'golftio_button_section_genaral',
            [
        ...
        $this->add_responsive_control(
            'golftio_button_content_align',
            [
                'label'         => esc_html__('Button Align', 'golftio-core'),
                'type'             => \Elementor\Controls_Manager::CHOOSE,
                'options'         => [
                    'left'         => [
                        'title' => esc_html__('Left', 'golftio-core'),
        ...
        // Button text
        $this->add_control(
            'golftio_heading_content_button',
            [
                'label' => esc_html__('Button', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
        ...
        // Button URL
        $this->add_control(
            'golftio_heading_content_button_url',
            [
        ...
        $this->add_control(
            'card_bgcolor',
            [
                'label'     => esc_html__('Card Background', 'golftio-core'),
        ...
        $this->add_control(
            'card_top_bgcolor',
            [
                'label'     => esc_html__('Card Head Background', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Pricing Content', 'golftio-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            'pricing_title_style',
            [
                'label' => esc_html__('Pricing Title', 'golftio-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('List Icon', 'golftio-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
...
?>
        ...
        <?php if ($settings['golftio_pricing_content_style_selection'] == 'style_one') : ?>
                    ...
                    <div class="pricing__card">
                        <div class="pricing__card-head">
                            <?php if ('yes' === $settings['show_icon']) : ?>
                                <?php if (!empty($settings['golftio_pricing_card_icon'])) : ?>
                                    <div class="pricing__card-head__thumb">
                                        <?php \Elementor\Icons_Manager::render_icon($settings['golftio_pricing_card_icon'], ['aria-hidden' => 'true']); ?>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                            <?php if (!empty($settings['golftio_pricing_content'])) : ?>
                                <h2><?php echo wp_kses($settings['golftio_pricing_content'], wp_kses_allowed_html('post')) ?></h2>
                            <?php endif; ?>
                            <?php if (!empty($settings['golftio_pricing_content_title'])) : ?>
                                <h5 class="cus_title"><?php echo wp_kses($settings['golftio_pricing_content_title'], wp_kses_allowed_html('post')) ?></h5>
                            <?php endif; ?>
                            <?php if (!empty($settings['golftio_pricing_content_description'])) : ?>
                                <p class="pp secondary-text"><?php echo wp_kses($settings['golftio_pricing_content_description'], wp_kses_allowed_html('post')) ?></p>
                            <?php endif; ?>
                            <hr>
                        </div>
                        ...
                        <?php if (!empty($settings['golftio_heading_content_button'])) : ?>
                            <div class="pricing__card-cta">
                                <a href="<?php echo esc_html($settings['golftio_heading_content_button_url']['url']) ?>" class="cmn-button"><?php echo esc_html($settings['golftio_heading_content_button']) ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <!-- ==== pricing section One start ==== -->
        <?php if ($settings['golftio_pricing_content_style_selection'] == 'style_one_alt') : ?>
            <section class="pricing pricing--secondary  pricing--tertiary wow fadeInUp" data-wow-duration="0.4s">
                <div class="plan-tablee">
                    <div class="pricing__card">
                        ...
                        <?php if (!empty($settings['golftio_heading_content_button'])) : ?>
                            <div class="pricing__card-cta">
                                <a href="<?php echo esc_html($settings['golftio_heading_content_button_url']['url']) ?>" class="cmn-button cmn-button--secondary"><?php echo esc_html($settings['golftio_heading_content_button']) ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <?php if ($settings['golftio_pricing_content_style_selection'] == 'style_two') : ?>
