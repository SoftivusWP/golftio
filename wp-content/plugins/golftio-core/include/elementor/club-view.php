...
class TP_club_view extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'golftio_club_section_genaral',
            [
                'label' => esc_html__('Club View Section', 'golftio-core')
            ]
        );


        $this->add_control(
            'golftio_club_content_style_selection',
            [
        ...
        $this->start_controls_section(
            ...
            [
                ...
                'condition' => [
                    'golftio_club_content_style_selection' => ['style_one','style_one_alt'],
                ]
            ]
        );
        ...
        $this->add_control(
            'golftio_club_one_content_image',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Club View', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'golftio_list_content' => esc_html__( 'Type your list content', 'plugin-name' ),
                ...
                'title_field' => '{{{ golftio_list_content }}}',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Content', 'golftio-core'),
                'condition' => [
                    'golftio_club_content_style_selection' => 'style_two',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'golftio_list_two_content' => esc_html__( 'Type your list content', 'plugin-name' ),
                ...
                'title_field' => '{{{ golftio_list_two_content }}}',
            ]
        );

         // Button text
         $this->add_control(
            'golftio_content_button_two',
            [
                'label' => esc_html__('Button', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Read More', 'golftio-core'),
        ...
        // Button URL
        $this->add_control(
            'golftio_content_button_url_two',
            [
                'label' => esc_html__('Button URL', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::URL,
                'placeholder' => esc_html__('https://your-link.com', 'golftio-core'),
        ...
        $this->start_controls_section( 
            ...
            [
                'label' => esc_html__('Popup Content', 'golftio-core'),
                'condition' => [
                    'golftio_club_content_style_selection' => 'style_two'
                ]
            ]
        ...
        $this->add_control(
            'card_bg_style_color',
            [
                'label'     => esc_html__('Club Bg', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Club-2 Bg', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
    ...
    <!-- ==== club section start ==== -->
    <?php if ($settings['golftio_club_content_style_selection'] == 'style_one') : ?>
        <section class="section club" data-background="<?php echo get_template_directory_uri(); ?>/assets/images/flag-bg.png">
            <div class="container">
                <div class="row section__row">
                                    ...
                                    <ul>
                                        <?php foreach ($settings['list_content_repeater'] as $item) : ?>
                                            <li>
                                                ...
                                                <?php echo !empty($item['golftio_list_content']) ? esc_html($item['golftio_list_content']) : ''; ?>
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
                                </div>
                    ...
                    <div class="col-lg-6 col-xl-5 offset-xl-1 section__col d-none d-lg-block">
                        <div class="club__thumb wow fadeInUp" data-wow-duration="0.4s">
                            <?php if (!empty($settings['golftio_club_one_content_image']['url'])) :   ?>
                                <img src="<?php echo esc_url($settings['golftio_club_one_content_image']['url']) ?>"  alt="<?php echo esc_attr('Image') ?>" class="unset">
                            <?php endif ?>   
    ...
    <?php if ($settings['golftio_club_content_style_selection'] == 'style_one_alt') : ?>
        <section class="section club club--alt" data-background="<?php echo get_template_directory_uri(); ?>/assets/images/flag-bg.png">
            <div class="container">
                <div class="row section__row">
    ...
    <?php if ($settings['golftio_club_content_style_selection'] == 'style_two') : ?>
                    ...
                    <div class="col-lg-6 col-xl-6 section__col">
                        <div class="section__content">
                            ...
                            <?php if (!empty($settings['golftio_heading_two_content_description'])) :   ?>
                                <p class="xlr pp"><?php echo wp_kses($settings['golftio_heading_two_content_description'], wp_kses_allowed_html('post'))  ?></p>
                            <?php endif ?>
                                ...
                                <div class="section__content-inner">
                                    <ul>
                                        <?php foreach ($settings['list_two_content_repeater'] as $item) : ?>
                                            <li>
                                                <i class="golftio-pin-checked"></i>
                                                <?php echo !empty($item['golftio_list_two_content']) ? esc_html($item['golftio_list_two_content']) : ''; ?>
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
                                </div>
                            <?php endif ?>
                            <?php if(!empty($settings['golftio_content_button_two'])) : ?>
                                <div class="section__content-cta">  
                                    <a href="<?php echo esc_html($settings['golftio_content_button_url_two']['url']) ?>" class="cmn-button"><?php echo esc_html($settings['golftio_content_button_two']) ?></a>
                                </div>          
                            <?php endif ?>
                        </div>
                    </div>
                        ...
                        <div class="join-club__thumb wow fadeInUp" data-wow-duration="0.4s">
                            ...
                            <div class="play-wrapper">
                                <?php if (!empty($settings['golftio_popup_card_icon'])) :   ?>
                                    <a href="<?php echo esc_html($settings['golftio_popup_link']['url']) ?>" class="play-btn" target="<?php echo esc_attr('_blank') ?>" title="<?php echo esc_attr('Youtube Video Player') ?>" >
