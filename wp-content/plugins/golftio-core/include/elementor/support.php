...
class TP_support extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'golftio_heading_content_style_selection',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Support', 'golftio-core'),
        ...
        //cont_card Section
        $this->start_controls_section(
            'golftio_cont_card_section_genaral',
            [
                'label' => esc_html__('Support Card', 'golftio-core')
            ]
        );


        $this->add_responsive_control(
            'golftio_cont_card_content_align',
            [
                'label'         => esc_html__('Card Text Align', 'golftio-core'),
                'type'             => \Elementor\Controls_Manager::CHOOSE,
                'options'         => [
                    'left'         => [
                        'title' => esc_html__('Left', 'golftio-core'),
        ...
        $repeater->add_control(
            'golftio_support_card_title',
            [
                'label' => esc_html__('support Title', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Location', 'golftio-core'),
                'placeholder' => esc_html__('Type your title here', 'golftio-core'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('On the other hand, we denounce with righteous indignation and dislike men', 'golftio-core'),
                'placeholder' => esc_html__('Type your title here', 'golftio-core'),
                'label_block' => true,
            ]
        );
        ...
        // Button text
        $repeater->add_control(
            'golftio_support_button',
            [
                'label' => esc_html__('Button', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Download', 'golftio-core'),
        ...
        $this->add_control(
            'support_repeater',
            [
                'label' => esc_html__('Contact Info', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'golftio_support_card_title' => esc_html__('Documentation', 'golftio-core'),
                    ],
                    [
                        'golftio_support_card_title' => esc_html__('Documentation', 'golftio-core'),
                    ],
                ],
                'title_field' => '{{{ golftio_support_card_title }}}',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('BG Before Color', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Card Title', 'golftio-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
                    ...
                    <?php foreach ($settings['support_repeater'] as $item) : ?>
                        <div class="col-sm-10 col-md-6 col-xl-4">
                            <div class="support__single">
                                <?php if (!empty($item['golftio_support_card_icon'])) : ?>
                                    <div class="support__single-thumb">
                                        <?php \Elementor\Icons_Manager::render_icon($item['golftio_support_card_icon'], ['aria-hidden' => 'true']); ?>
                                    </div>
                                <?php endif; ?>
                                <div class="support__single-content">
                                    <?php if (!empty($item['golftio_support_card_title'])) : ?>
                                        <h5 class="cus_title"><?php echo wp_kses($item['golftio_support_card_title'], wp_kses_allowed_html('post')) ?></h5>
                                    <?php endif; ?>
                                    <?php if (!empty($item['golftio_support_des'])) : ?>
                                        <p class="card_text secondary-text"><?php echo esc_html($item['golftio_support_des']) ?></p>
                                    <?php endif; ?>
                                    <?php if (!empty($item['golftio_support_button'])) : ?>
                                        <a href="<?php echo wp_kses($item['golftio_support_button_url']['url'], wp_kses_allowed_html('post')) ?>" class="cmn-button cmn-button--secondary"><?php echo esc_html($item['golftio_support_button']) ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
