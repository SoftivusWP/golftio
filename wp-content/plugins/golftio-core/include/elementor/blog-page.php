    ...
    <?php
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'style_one' => esc_html__('Style Grid', 'golftio-core'),
                    'style_two' => esc_html__('Style Left Sidebar', 'golftio-core'),
                    'style_three' => esc_html__('Style Right Sidebar', 'golftio-core'),
                ],
                'default' => 'style_one',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Posts Per Page Show', 'golftio-core')
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Posts Per Page', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Order By', 'golftio-core'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'ID',
                'options' => [
                    'ID'         => esc_html__('Post Id', 'golftio-core'),
                    'author'     => esc_html__('Post Author', 'golftio-core'),
                    'title'      => esc_html__('Title', 'golftio-core'),
                    'post_date'  => esc_html__('Date', 'golftio-core'),
                    'rand'       => esc_html__('Random', 'golftio-core'),
                    'menu_order' => esc_html__('Menu Order', 'golftio-core'),
                ],
            ]
        );
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Order', 'golftio-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'asc'  => esc_html__('Ascending', 'golftio-core'),
                    'desc' => esc_html__('Descending', 'golftio-core')
                ],
                'default' => 'desc',
            ]
        );
        ...
        $this->add_control(
            'meta_part_show',
            [
                'label' => esc_html__('Meta Part', 'golftio-core'),
        ...
        $this->add_control(
            'title_part_show',
            [
                'label' => esc_html__('Title Part', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'golftio-core'),
                'label_off' => esc_html__('Hide', 'golftio-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'trim_words_count',
            [
                'label' => esc_html__('Trim Words Title', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'default' => esc_html__('7', 'golftio-core'),
        ...
        $this->add_control(
            'content_part_show',
            [
                'label' => esc_html__('Content Part', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'golftio-core'),
                'label_off' => esc_html__('Hide', 'golftio-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Trim Words Content', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'default' => esc_html__('15', 'golftio-core'),
                'placeholder' => esc_html__('Type your number here', 'golftio-core'),
                'condition' => [
        ...
        $this->add_control(
            'button_part_show',
            [
                'label' => esc_html__('Button Part', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'golftio-core'),
                'label_off' => esc_html__('Hide', 'golftio-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'btn_icon_show',
            [
                'label' => esc_html__('Button Icon Show', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'golftio-core'),
                'label_off' => esc_html__('Hide', 'golftio-core'),
                'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            'golftio_card_content_align',
            [
                'label'         => esc_html__('Card Align', 'golftio-core'),
        ...
        $this->add_control(
            'category_show',
            [
                'label' => esc_html__('Category Show', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'golftio-core'),
                'label_off' => esc_html__('Hide', 'golftio-core'),
                'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            'golftio_category_position',
            [
                'label'         => esc_html__('Category Position', 'golftio-core'),
                'type'          => \Elementor\Controls_Manager::CHOOSE,
                'options'       => [
                    'top-left'      => [
                        'title' => esc_html__('Top Left', 'golftio-core'),
                        'icon'  => 'eicon-h-align-left',
                    ],
                    'top-right'     => [
                        'title' => esc_html__('Top Right', 'golftio-core'),
                        'icon'  => 'eicon-h-align-right',
                    ],
                    'bottom-left'   => [
                        'title' => esc_html__('Bottom Left', 'golftio-core'),
                        'icon'  => 'eicon-v-align-bottom',
                    ],
                    'bottom-right'  => [
                        'title' => esc_html__('Bottom Right', 'golftio-core'),
                        'icon'  => 'eicon-v-align-bottom',
                    ],
                ],
                'default'       => 'top-left',
        ...
        $this->add_control(
            'meta_icon_show',
            [
                'label' => esc_html__('Meta Icon', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'golftio-core'),
                'label_off' => esc_html__('Hide', 'golftio-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'meta_admin_show',
            [
                'label' => esc_html__('Meta Admin', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'golftio-core'),
                'label_off' => esc_html__('Hide', 'golftio-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'meta_calender_show',
            [
                'label' => esc_html__('Meta Calender', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'golftio-core'),
                'label_off' => esc_html__('Hide', 'golftio-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'meta_comments_show',
            [
                'label' => esc_html__('Meta Comments', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'golftio-core'),
                'label_off' => esc_html__('Hide', 'golftio-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Meta Inner Gap', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Meta Gap', 'golftio-core'),
                'type'      => Controls_Manager::GAPS,
                'size_units' => ['px', '%', 'em', 'rem', 'vw'],
                'selectors'  => [
        ...
        $this->add_group_control(
            Group_Control_Background::get_type(),
            [
                'label'     => esc_html__('BG Hover Color', 'golftio-core'),
        ...
        $this->add_responsive_control(
            'golftio_pagination_content_align',
            [
                'label'         => esc_html__('Pagination Align', 'golftio-core'),
                'type'             => \Elementor\Controls_Manager::CHOOSE,
                'options'         => [
                    'left'         => [
                        'title' => esc_html__('Left', 'golftio-core'),
        ...
        $this->add_control(
            'pagi_text_color',
            [
                'label'     => esc_html__('Pagination Text Color', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Pagination Hover/Active Color', 'golftio-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'counter_bdr_color',
            [
                'label' => esc_html__('Border Hover Color', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Pagination Box Size', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
