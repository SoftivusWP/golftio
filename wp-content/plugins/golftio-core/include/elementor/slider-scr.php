...
class TP_slider extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'golftio_slider_card_section_genaral',
            [
                'label' => esc_html__('Gallery Slider', 'golftio-core')
            ]
        );
        ...
        $this->add_control(
            'golftio_slider_carousel',
            [
                'label' => esc_html__('Add Images', 'golftio-core'),
        ...
        $this->start_controls_section(
            'gallery_style',
            [
                'label' => esc_html__('Image', 'golftio-core'),
...
?>
        ...
        <section class="gallery-slider section">
            ...
            <div class="gallery-slider__wrapper">
                <?php foreach ($settings['golftio_slider_carousel'] as $item) : ?>
