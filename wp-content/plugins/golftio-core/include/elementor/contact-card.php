...
class TP_con_card extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Contact Card', 'golftio-core')
            ]
        );
        ...
        $this->add_control(
            'golftio_cont_card_icon',
            [
                'label' => esc_html__('Icon', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::ICONS,
                'default' => [
                    'value' => 'golftio-pin-location',
                    'library' => 'solid',
                ],
            ]
        );
        ...
        $repeater->add_control(
            'golftio_cont_content',
            [
                'label' => esc_html__('Contact ', 'golftio-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Royal Ln. Mesa, New Jersey 45463', 'golftio-core'),
                'placeholder' => esc_html__('Type your title here', 'golftio-core'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'golftio_cont_content_link',
            [
                'label' => esc_html__('Contact Link', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'golftio_cont_content' => esc_html__('Royal Ln. Mesa, New Jersey 45463', 'golftio-core'),
                    ],
                    [
                        'golftio_cont_content' => esc_html__('Royal Ln. Mesa, New Jersey 45463', 'golftio-core'),
                    ],
                ],
                'title_field' => '{{{ golftio_cont_content }}}',
            ]
        );
...
?>
        ...
        <div class="contact wow fadeInUp" data-wow-duration="0.4s">
            <div class="contact__item">
                <?php if (!empty($settings['golftio_cont_card_icon'])) : ?>
                    <div class="contact__item-thumb">
                        <?php \Elementor\Icons_Manager::render_icon($settings['golftio_cont_card_icon'], ['aria-hidden' => 'true']); ?>
                    </div>
                <?php endif; ?>
                <div class="contact__item-content">
                    <?php if (!empty($settings['golftio_cont_card_title'])) : ?>
                        <h5 class="cus_title"><?php echo wp_kses($settings['golftio_cont_card_title'], wp_kses_allowed_html('post')) ?></h5>
                    <?php endif; ?>
                    <?php foreach ($settings['cont_repeater'] as $item) : ?>
                        <?php if (!empty($item['golftio_cont_content_link']['url'])) : ?>
                            <a href="<?php echo wp_kses($item['golftio_cont_content_link']['url'], wp_kses_allowed_html('post')) ?>" class="pp secondary-text d-block"><?php echo esc_html($item['golftio_cont_content']) ?></a>
                        <?php else : ?>
                            <p class="pp secondary-text"><?php echo esc_html($item['golftio_cont_content']) ?></p>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </div>
            </div>
