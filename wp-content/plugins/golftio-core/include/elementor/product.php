...
class TP_product extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'golftio_product_section_genaral',
            [
                'label' => esc_html__('product Section', 'golftio-core')
            ]
        );


        $this->add_control(
            'golftio_product_content_style_selection',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Shop', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Featured products', 'golftio-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('See all products', 'golftio-core'),
...
?>
        ...
        <?php if ($settings['golftio_product_content_style_selection'] == 'style_one') : ?>
            <section class="section shop wow fadeInUp" data-wow-duration="0.4s" data-background="<?php echo get_template_directory_uri() ?>/assets/images/player-bg.png">
                <div class="container">
        ...
        <?php if ($settings['golftio_product_content_style_selection'] == 'style_two') : ?>
            <section class="section shop shop--secondary wow fadeInUp" data-wow-duration="0.4s" data-background="<?php echo get_template_directory_uri() ?>/assets/images/player-bg.png">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="section__header">
