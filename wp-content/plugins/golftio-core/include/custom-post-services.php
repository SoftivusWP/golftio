...
class TpServicesPost 
{
	...
	public function register_custom_post_type() {
		...
		$labels = array(
			...
			'singular_name'         => esc_html_x( 'Services', 'Post Type Singular Name', 'tpcore' ),
			...
			'add_new_item'          => esc_html__( 'Add New Services', 'tpcore' ),
		...
		$args   = array(
			'label'                 => esc_html__( 'Services', 'tpcore' ),
			'labels'                => $labels,
	...
	public function create_cat() {
		$labels = array(
			'name'                       => esc_html_x( 'Services Categories', 'Taxonomy General Name', 'tpcore' ),
			'singular_name'              => esc_html_x( 'Services Categories', 'Taxonomy Singular Name', 'tpcore' ),
			'menu_name'                  => esc_html__( 'Services Categories', 'tpcore' ),
			'all_items'                  => esc_html__( 'All Services Category', 'tpcore' ),
			'parent_item'                => esc_html__( 'Parent Item', 'tpcore' ),
			'parent_item_colon'          => esc_html__( 'Parent Item:', 'tpcore' ),
			'new_item_name'              => esc_html__( 'New Services Category Name', 'tpcore' ),
			'add_new_item'               => esc_html__( 'Add New Services Category', 'tpcore' ),
			'edit_item'                  => esc_html__( 'Edit Services Category', 'tpcore' ),
			'update_item'                => esc_html__( 'Update Services Category', 'tpcore' ),
			'view_item'                  => esc_html__( 'View Services Category', 'tpcore' ),
			...
			'popular_items'              => esc_html__( 'Popular Services Category', 'tpcore' ),
			'search_items'               => esc_html__( 'Search Services Category', 'tpcore' ),
			'not_found'                  => esc_html__( 'Not Found', 'tpcore' ),
			'no_terms'                   => esc_html__( 'No Services Category', 'tpcore' ),
			'items_list'                 => esc_html__( 'Services Category list', 'tpcore' ),
			'items_list_navigation'      => esc_html__( 'Services Category list navigation', 'tpcore' ),
		);
