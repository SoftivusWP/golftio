...
class TpEventPost 
{
	...
	public function register_custom_post_type() {
		...
		$labels = array(
			'name'                  => esc_html_x( 'Event', 'Post Type General Name', 'tpcore' ),
			'singular_name'         => esc_html_x( 'Event', 'Post Type Singular Name', 'tpcore' ),
			'menu_name'             => esc_html__( 'Event', 'tpcore' ),
			'name_admin_bar'        => esc_html__( 'Event', 'tpcore' ),
			...
			'add_new_item'          => esc_html__( 'Add New Event', 'tpcore' ),
	...
	public function create_cat() {
		$labels = array(
			'name'                       => esc_html_x( 'Event Categories', 'Taxonomy General Name', 'tpcore' ),
			'singular_name'              => esc_html_x( 'Event Categories', 'Taxonomy Singular Name', 'tpcore' ),
			'menu_name'                  => esc_html__( 'Event Categories', 'tpcore' ),
			'all_items'                  => esc_html__( 'All Event Category', 'tpcore' ),
			'parent_item'                => esc_html__( 'Parent Item', 'tpcore' ),
			'parent_item_colon'          => esc_html__( 'Parent Item:', 'tpcore' ),
			'new_item_name'              => esc_html__( 'New Event Category Name', 'tpcore' ),
			'add_new_item'               => esc_html__( 'Add New Event Category', 'tpcore' ),
			'edit_item'                  => esc_html__( 'Edit Event Category', 'tpcore' ),
			'update_item'                => esc_html__( 'Update Event Category', 'tpcore' ),
			'view_item'                  => esc_html__( 'View Event Category', 'tpcore' ),
			...
			'popular_items'              => esc_html__( 'Popular Event Category', 'tpcore' ),
			'search_items'               => esc_html__( 'Search Event Category', 'tpcore' ),
			'not_found'                  => esc_html__( 'Not Found', 'tpcore' ),
			'no_terms'                   => esc_html__( 'No Event Category', 'tpcore' ),
			'items_list'                 => esc_html__( 'Event Category list', 'tpcore' ),
			'items_list_navigation'      => esc_html__( 'Event Category list navigation', 'tpcore' ),
		);
