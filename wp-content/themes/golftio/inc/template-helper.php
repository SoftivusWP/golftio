...
{
    $bentox_header_style = function_exists('get_field') ? get_field('header_style') : NULL;
    $bentox_default_header_style = get_theme_mod('choose_default_header', 'header-style-1');

    if ($bentox_header_style == 'header-style-1' && empty($_GET['s'])) {
        get_template_part('template-parts/header/header-1');
    } elseif ($bentox_header_style == 'header-style-2' && empty($_GET['s'])) {
        get_template_part('template-parts/header/header-2');
    } elseif ($bentox_header_style == 'header-style-3' && empty($_GET['s'])) {
        get_template_part('template-parts/header/header-3');
    } else {

        /** default header style **/
        if ($bentox_default_header_style == 'header-style-2') {
            get_template_part('template-parts/header/header-2');
        } elseif ($bentox_default_header_style == 'header-style-3') {
            get_template_part('template-parts/header/header-3');
        } else {
            get_template_part('template-parts/header/header-1');
        }
...
add_action('bentox_header_style', 'bentox_check_header', 10);
...
function bentox_header_lang_defualt()
{
    ...
    if ($bentox_header_lang) : ?>
        ...
        <ul>
            <li><a href="javascript:void(0)" class="lang__btn"><?php print esc_html__('English', 'golftio'); ?> <i class="fa-light fa-angle-down"></i></a>
...
function bentox_language_list()
{
    ...
    if (!empty($languages)) {
        ...
        $mar .= '<ul>';
        $mar .= '<li><a href="#">' . esc_html__('English', 'golftio') . '</a></li>';
        $mar .= '<li><a href="#">' . esc_html__('Bangla', 'golftio') . '</a></li>';
        $mar .= '<li><a href="#">' . esc_html__('French', 'golftio') . '</a></li>';
        $mar .= ' </ul>';
    }
...
// header logo
function bentox_header_logo()
{ ?>
    <?php
    $bentox_logo_on = function_exists('get_field') ? get_field('is_enable_sec_logo') : NULL;
    $bentox_logo = get_template_directory_uri() . '/assets/images/logo/logo.png';
    $bentox_logo_black = get_template_directory_uri() . '/assets/images/logo/logosecondary.png';

    $bentox_site_logo = get_theme_mod('logo', $bentox_logo);
    $bentox_secondary_logo = get_theme_mod('seconday_logo', $bentox_logo_black);
    ?>

    <?php if (!empty($bentox_logo_on)) : ?>
        <a class="secondary-logo" href="<?php print esc_url(home_url('/')); ?>">
            <img src="<?php print esc_url($bentox_secondary_logo); ?>" alt="<?php print esc_attr__('logo', 'golftio'); ?>" />
        </a>
    <?php else : ?>
        <a class="standard-logo" href="<?php print esc_url(home_url('/')); ?>">
            <img src="<?php print esc_url($bentox_site_logo); ?>" alt="<?php print esc_attr__('logo', 'golftio'); ?>" />
        </a>
    <?php endif; ?>
<?php
}
...
{
    $bentox_topbar_fb_url = get_theme_mod('bentox_topbar_fb_url', __('#', 'golftio'));
    $bentox_topbar_twitter_url = get_theme_mod('bentox_topbar_twitter_url', __('#', 'golftio'));
    $bentox_topbar_instagram_url = get_theme_mod('bentox_topbar_instagram_url', __('#', 'golftio'));
    $bentox_topbar_linkedin_url = get_theme_mod('bentox_topbar_linkedin_url', __('#', 'golftio'));
    $bentox_topbar_youtube_url = get_theme_mod('bentox_topbar_youtube_url', __('#', 'golftio'));
?>
    <ul>
...
{
    $bentox_footer_fb_url = get_theme_mod('bentox_footer_fb_url', __('#', 'golftio'));
    $bentox_footer_twitter_url = get_theme_mod('bentox_footer_twitter_url', __('#', 'golftio'));
    $bentox_footer_instagram_url = get_theme_mod('bentox_footer_instagram_url', __('#', 'golftio'));
    $bentox_footer_linkedin_url = get_theme_mod('bentox_footer_linkedin_url', __('#', 'golftio'));
    $bentox_footer_youtube_url = get_theme_mod('bentox_footer_youtube_url', __('#', 'golftio'));
?>
...
function bentox_copyright_text()
{
    ...
    $copyright_text = get_theme_mod('bentox_copyright', 'Copyright © 2024 <a href="' . $home_url . '">Golftio</a> - All Rights Reserved');
