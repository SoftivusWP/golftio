...
function bentox_widgets_init() {
     ...
     */
    register_sidebar( [
        'name'          => esc_html__( 'Blog Sidebar', 'golftio' ),
        'id'            => 'blog-sidebar',
        'description'          => esc_html__( 'Set Your Blog Widget', 'golftio' ),
    ...
    for ( $num = 1; $num <= $footer_widgets; $num++ ) {
        register_sidebar( [
            'name'          => sprintf( esc_html__( 'Footer %1$s', 'golftio' ), $num ),
            'id'            => 'footer-' . $num,
            'description'   => sprintf( esc_html__( 'Footer column %1$s', 'golftio' ), $num ),
