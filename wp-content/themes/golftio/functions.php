...
if ( !function_exists( 'bentox_setup' ) ):
    ...
    function bentox_setup() {
         ...
         * to change 'golftio' to the name of your theme in all the template files.
         */
        load_theme_textdomain( 'golftio', get_template_directory() . '/languages' );
        ...
        register_nav_menus( [
            'main-menu' => esc_html__( 'Main Menu', 'golftio' ),
            'category-menu' => esc_html__( 'Category Menu', 'golftio' ),
            'footer-menu' => esc_html__( 'Footer Menu', 'golftio' ),
        ] );
...
define( 'GOLFTION_THEME_DIR', get_template_directory() );
define( 'GOLFTION_THEME_URI', get_template_directory_uri() );
define( 'GOLFTION_THEME_CSS_DIR', GOLFTION_THEME_URI . '/assets/css/' );
define( 'GOLFTION_THEME_JS_DIR', GOLFTION_THEME_URI . '/assets/js/' );
define( 'GOLFTION_THEME_INC', GOLFTION_THEME_DIR . '/inc/' );
 ...
 */
require GOLFTION_THEME_INC . 'custom-header.php';

/**
 * Functions which enhance the theme by hooking into WordPress.
 */
require GOLFTION_THEME_INC . 'template-functions.php';

/**
 * Custom template helper function for this theme.
 */
require GOLFTION_THEME_INC . 'template-helper.php';

/**
 * initialize kirki customizer class.
 */
include_once GOLFTION_THEME_INC . 'kirki-customizer.php';
include_once GOLFTION_THEME_INC . 'class-bentox-kirki.php';

/**
 * Load Jetpack compatibility file.
 */
if ( defined( 'JETPACK__VERSION' ) ) {
    require GOLFTION_THEME_INC . 'jetpack.php';
}
 ...
 */
require_once GOLFTION_THEME_INC . 'class-navwalker.php';
require_once GOLFTION_THEME_INC . 'class-tgm-plugin-activation.php';
require_once GOLFTION_THEME_INC . 'add_plugin.php';
require_once GOLFTION_THEME_INC . '/common/bentox-breadcrumb.php';
require_once GOLFTION_THEME_INC . '/common/bentox-scripts.php';
require_once GOLFTION_THEME_INC . '/common/bentox-widgets.php';
